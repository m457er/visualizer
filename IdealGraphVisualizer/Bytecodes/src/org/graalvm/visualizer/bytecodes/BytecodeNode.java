...
public class BytecodeNode extends AbstractNode {
    ...
    public Image getIcon(int i) {
        if (nodes != null) {
            return ImageUtilities.loadImage("org/graalvm/visualizer/bytecodes/images/link.png");
        } else {
            return ImageUtilities.loadImage("org/graalvm/visualizer/bytecodes/images/bytecode.png");
        }
    }
