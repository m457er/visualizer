...
public class ConstantPool {
     ...
     * Original pool contents is retuned in a new instance of ConstantPool.
     * <p/>
     * The method effectively forks the constant pool, retains some previous snapshot in <b>this
     * instance</b> (assuming there are already some refereces to it), and the current state is
     * returned as a new instance of ConstantPool.
     * 
     * @param replacementData new data for this constant pool, preferrably made by {@link #snapshot}
     *            .
     * 
