...
import org.graalvm.visualizer.util.ContextAction;
...
public final class PrevDiagramAction extends ContextAction<DiagramViewModel> implements ChangedListener<DiagramViewModel> {
    ...
    public PrevDiagramAction(Lookup lookup) {
        ...
        putValue(Action.SMALL_ICON, new ImageIcon(ImageUtilities.loadImage("org/graalvm/visualizer/view/images/prev_diagram.png")));
    }
